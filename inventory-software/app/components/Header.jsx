                ...
                <div className="flex gap-12 items-center">
                    ...
                    <nav aria-label="Main navigation">
                        <ul className="flex gap-8 p-0 m-0">
                            <li><a className="text-black no-underline" href="/features">Features</a></li>
                            <li><a className="text-black no-underline" href="/solutions">Solutions</a></li>
                            <li><a className="text-black no-underline" href="/pricing">Pricing</a></li>
                            <li><a className="text-black no-underline" href="/contact">Contact</a></li>
                        </ul>
                    </nav>
                </div>
