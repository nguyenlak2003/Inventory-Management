...
function SaleOrderTable({ orders, onRemoveOrder, onShowDetails }) {
    ...
    return (
        <div className="overflow-auto rounded-lg bg-white shadow-[0_2px_4px_rgba(0,0,0,0.1)]">
            <table
                role="grid"
                aria-label="Sale Orders Table"
                className="w-full border-collapse min-w-[800px]"
            >
                <caption className="absolute left-[-9999px]">
                    List of sale orders showing customer, order details, and actions
                </caption>
                <thead>
                    ...
                    {sortedOrders.length === 0 ? (
                        <tr>
                            <td colSpan={6} className="px-4 py-8 text-center text-zinc-500">
                                No sale orders yet, please add a sale order
                            </td>
                        </tr>
                    ) : (
